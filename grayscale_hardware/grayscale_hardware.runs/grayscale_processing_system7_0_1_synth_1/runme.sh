...
HD_PWD='D:/cse_462/fgpa_convolution_acceleration/grayscale_hardware/grayscale_hardware.runs/grayscale_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grayscale_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grayscale_processing_system7_0_1.tcl
