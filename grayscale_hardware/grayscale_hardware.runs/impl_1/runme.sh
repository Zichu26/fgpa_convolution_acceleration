...
HD_PWD='D:/cse_462/fgpa_convolution_acceleration/grayscale_hardware/grayscale_hardware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log grayscale_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source grayscale_wrapper.tcl -notrace
