...
HD_PWD='D:/cse_462/fgpa_convolution_acceleration/grayscale_hardware/grayscale_hardware.runs/grayscale_grayscale_kernel_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grayscale_grayscale_kernel_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grayscale_grayscale_kernel_0_2.tcl
