...
HD_PWD='D:/cse_462/fgpa_convolution_acceleration/grayscale_hardware/grayscale_hardware.runs/grayscale_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grayscale_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grayscale_rst_ps7_0_100M_0.tcl
