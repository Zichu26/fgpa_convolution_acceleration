...
// ==============================================================
`timescale 1ns/1ps
module filter_kernel_control_s_axi
#(parameter
    ...
    output wire [31:0]                   filter_divisor,
...
localparam
    ...
    ADDR_IER                   = 7'h08,
    ADDR_ISR                   = 7'h0c,
    ADDR_FILTER_DIVISOR_DATA_0 = 7'h10,
    ADDR_FILTER_DIVISOR_CTRL   = 7'h14,
    ADDR_WIDTH_DATA_0          = 7'h18,
    ADDR_WIDTH_CTRL            = 7'h1c,
    ADDR_HEIGHT_DATA_0         = 7'h20,
    ADDR_HEIGHT_CTRL           = 7'h24,
    ADDR_CHANNELS_DATA_0       = 7'h28,
    ADDR_CHANNELS_CTRL         = 7'h2c,
    ADDR_FILTER_BASE           = 7'h40,
    ADDR_FILTER_HIGH           = 7'h7f,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_filter_divisor = 'b0;
...
//------------------------Instantiation------------------
// int_filter
filter_kernel_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 9 )
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FILTER_DIVISOR_DATA_0: begin
                    rdata <= int_filter_divisor[31:0];
                end
...
assign filter_divisor    = int_filter_divisor;
...
// int_filter_divisor[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_filter_divisor[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FILTER_DIVISOR_DATA_0)
            int_filter_divisor[31:0] <= (WDATA[31:0] & wmask) | (int_filter_divisor[31:0] & ~wmask);
    end
end
...
assign int_filter_be1      = int_filter_we1 ? WSTRB : 'b0;
...
module filter_kernel_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
