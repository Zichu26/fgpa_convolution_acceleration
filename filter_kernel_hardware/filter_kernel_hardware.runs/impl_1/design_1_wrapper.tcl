namespace eval ::optrace {
  variable script "D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.cache/wt [current_project]
  set_property parent.project_path D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.xpr [current_project]
  set_property ip_repo_paths D:/cse_462/image_kernel/image_kernel/hls/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.srcs/sources_1/bd/design_1/design_1.bd
