...
HD_PWD='D:/cse_462/filter_kernel_hardware/filter_kernel_hardware.runs/design_1_axi_interconnect_2_imp_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_interconnect_2_imp_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_interconnect_2_imp_auto_ds_0.tcl
