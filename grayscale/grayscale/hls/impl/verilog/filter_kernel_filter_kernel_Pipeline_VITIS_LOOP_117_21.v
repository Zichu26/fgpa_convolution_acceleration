...
module filter_kernel_filter_kernel_Pipeline_VITIS_LOOP_117_21 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln117_fu_88_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln117_fu_88_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln117_fu_88_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln117_fu_94_p2 = (ap_sig_allocacmp_j + 11'd1);
...
assign icmp_ln117_fu_88_p2 = ((ap_sig_allocacmp_j == 11'd1920) ? 1'b1 : 1'b0);

assign line_buffer_3_address0 = zext_ln117_fu_100_p1;
...
assign line_buffer_4_address0 = zext_ln117_fu_100_p1;
...
assign line_buffer_5_address0 = zext_ln117_fu_100_p1;
...
assign zext_ln117_fu_100_p1 = ap_sig_allocacmp_j;

endmodule //filter_kernel_filter_kernel_Pipeline_VITIS_LOOP_117_21
