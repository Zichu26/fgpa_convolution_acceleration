...
HD_PWD='D:/cse_462/fgpa_convolution_acceleration/filter_hardware/filter_hardware.runs/design_1_filter_kernel_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_filter_kernel_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_filter_kernel_0_3.tcl
