...
#
# Script generated by Vivado on Mon Mar 24 01:09:16 -0500 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/cse_462/fgpa_convolution_acceleration/filter_hardware/filter_hardware.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
