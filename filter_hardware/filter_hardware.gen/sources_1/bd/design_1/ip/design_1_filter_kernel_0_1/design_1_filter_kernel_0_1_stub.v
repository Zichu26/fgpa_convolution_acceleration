...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_filter_kernel_0_1 -prefix
//               design_1_filter_kernel_0_1_ design_1_filter_kernel_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_filter_kernel_0_0,filter_kernel,{}" *) (* CORE_GENERATION_INFO = "design_1_filter_kernel_0_0,filter_kernel,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=filter_kernel,x_ipVersion=1.0,x_ipCoreRevision=2114002804,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=7,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "filter_kernel,Vivado 2024.2" *) (* hls_module = "yes" *) 
module design_1_filter_kernel_0_1(s_axi_control_ARADDR, 
