...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_filter_kernel_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_filter_kernel_0_2,filter_kernel,{}" *) (* CORE_GENERATION_INFO = "design_1_filter_kernel_0_2,filter_kernel,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=filter_kernel,x_ipVersion=1.0,x_ipCoreRevision=2114008687,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=6,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "filter_kernel,Vivado 2024.2" *) (* hls_module = "yes" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(kernel_ce0, kernel_we0, kernel_ce1, kernel_we1, 
  ...
  interrupt, kernel_address0, kernel_d0, kernel_q0, kernel_address1, kernel_d1, kernel_q1, 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_control:input_stream:output_stream, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_2_FCLK_CLK0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
